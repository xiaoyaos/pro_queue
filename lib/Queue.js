...
class Queue {
  ...
  async process(timeout, callback, sync = false){
    this.sync = arguments[arguments.length-1] || this.sync;
    this.callback = arguments[arguments.length-2] || this.callback;
    this.timeout = arguments[arguments.length-3] || this.timeout || 100;
